...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="admin/uploads/logo.2.jpg">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="admin/uploads/logo casio1.jpg" alt=""></a>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i><?php echo $k['email']?></li>
                                <li>Free Shipping for all Order of $99</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="admin/uploads/logo.1.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
